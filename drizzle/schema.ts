...
export const clients = mysqlTable("clients", {
  ...
  companyName: varchar("company_name", { length: 1000 }),
  cnpj: varchar("cnpj", { length: 20 }),
  contactName: varchar("contact_name", { length: 500 }),
  phone: varchar("phone", { length: 20 }),
  personType: varchar("person_type", { length: 50 }),
  razaoSocial: varchar("razao_social", { length: 1000 }),
  nomeFantasia: varchar("nome_fantasia", { length: 1000 }),
  ...
  email: varchar("email", { length: 255 }),
  clientType: varchar("client_type", { length: 500 }),
  businessGroup: varchar("business_group", { length: 500 }),
